...
public class GetCommunesHandler(IApplicationDbContext context, IApiResponseService responseService) : IRequestHandler<GetCommunes, ApiResponse<List<CommuneDto>>>
{
